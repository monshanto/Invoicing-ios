...
class UpdateCustomerAPIRequest: NSObject {
    
    static let shared = UpdateCustomerAPIRequest()
    
    func UpdateCustomer(requestParams : [String:Any], completion: @escaping (_ message : String?, _ status : Bool,_ session:Bool) -> Void) {
        ...
        AlamofireRequest.shared.PostBodyForRawData(urlString: "BaseURL".UpdateCustomerURL, parameters: requestParams, authToken: AppUser.accessToken, isLoader: true, loaderMessage: "Update") { (data, error) in
