...
class UpdateItemAPIRequest: NSObject {
    
    static let shared = UpdateItemAPIRequest()
    
    func UpdateItem(requestParams : [String:Any], completion: @escaping (_ message : String?, _ status : Bool,_ session:Bool) -> Void) {
        ...
        AlamofireRequest.shared.PostBodyForRawData(urlString: "BaseURL".UpdateItemURL, parameters: requestParams, authToken: AppUser.accessToken, isLoader: true, loaderMessage: "Update") { (data, error) in
