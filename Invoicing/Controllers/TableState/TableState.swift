...
enum TableState: CustomState {
    ...
    var image: UIImage? {
        ...
        case .noInternet: return UIImage(named: "Nointernet")
    ...
    var title: String? {
        ...
        case .noInternet: return "Can't load content"
    ...
    var description: String? {
        ...
        case .noSearch: return "You have no unpaid invoices"
        case .noTags: return "Go to collect favorites products"
        case .noInternet: return "Internet not available, Cross check your internet connectivity and try again"
