...
class TimeEntries: UIViewController {
    ...
    var Title = "No time entries"
    var subTitle = "Create your first time entries and get paid for your excellent work."
    var Image = ""
...
//            navigationItem.leftBarButtonItem = btSlider
    ...
    @IBAction func createNewExpence(_ sender: Any) {
        ...
        OpenRecordTime(Title: "")
        
    }
    
    func OpenRecordTime(Title:String)
    {
        let storyboard = UIStoryboard(name: "Home", bundle: nil)
        let vc = storyboard.instantiateViewController(withIdentifier: "RecordTime") as! RecordTime
        vc.Title = Title
    ...
    @objc func Filter_Action(){
        ...
        self.popupAlertWithSheet(title: nil, message: "Filter".uppercased(), actionTitles: [ "All","Unbilled","Billed"], actions:[
            {action1 in
...
extension TimeEntries : UITableViewDelegate,UITableViewDataSource , SwipeTableViewCellDelegate
{
...
extension TimeEntries: EmptyStateDelegate {
