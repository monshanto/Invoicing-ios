...
import Alamofire
class Quotations: UIViewController {
    ...
    var Title = "You haven't created any quotation"
    var subTitle = "Create your first quotation and get paid for your excellent work."
    var Image = ""
...
//            navigationItem.leftBarButtonItem = btSlider
    ...
    @IBAction func createNewQuotations(_ sender: Any) {
        
       OpenNewQuotations(Title: "New Quotation")
        
        
    }
    
    func OpenNewQuotations(Title:String)
    {
        let vc = storyboard?.instantiateViewController(withIdentifier: "CreateInvoice") as! CreateInvoice
        vc.ClassType = "Quotation"
        vc.Title = Title
...
extension Quotations : UITableViewDelegate,UITableViewDataSource , SwipeTableViewCellDelegate
{
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath, for orientation: SwipeActionsOrientation) -> [SwipeAction]? {
        ...
        let editAction = SwipeAction(style:.destructive, title: nil) { action, indexPath in
            ...
            self.OpenNewQuotations(Title: "Edit Quotation")
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if  NoDataFound == false
        {
        OpenNewQuotations(Title: "Quotation")
        }
...
extension Quotations: EmptyStateDelegate {
