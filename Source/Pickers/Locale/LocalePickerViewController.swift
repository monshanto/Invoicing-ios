...
extension LocalePickerViewController: UISearchResultsUpdating {
    ...
    func updateSearchResults(for searchController: UISearchController) {
        if let searchText = searchController.searchBar.text?.capitalized, searchController.isActive {
            filteredInfo = []
...
extension LocalePickerViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .currency:
            cell = tableView.dequeueReusableCell(withIdentifier: CurrencyCell.identifier) as! CurrencyCell
